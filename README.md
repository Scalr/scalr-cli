...
```
#linux 64bit example
wget -O /usr/bin/scalr https://github.com/Scalr/scalr-cli/blob/main/bin/scalr-linux-amd64
chmod +x /usr/bin/scalr

#macos 64bit example
wget -O /usr/bin/scalr https://github.com/Scalr/scalr-cli/blob/main/bin/scalr-darwin-amd64
chmod +x /usr/bin/scalr
```
...
This can be done using environment variables (SCALR_URL and SCALR_TOKEN) or a configuration file.
